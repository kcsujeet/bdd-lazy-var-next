# Contributing to BDD Lazy Vars Next

I would love for you to contribute to BDD Lazy Vars Next and help make it even better than it is
...
You can _request_ a new feature by [submitting an issue](#submit-issue) to this GitHub Repository. If you would like to _implement_ a new feature, please submit an issue with a proposal for your work first, to be sure that somebody else hasn't started to do the same.
...
- Search [GitHub](https://github.com/kcsujeet/bdd-lazy-var-next/pulls) for an open or closed PR
...
- Build distributable library files with `bun run build`. Run all test suites `bun test`.
...
- In GitHub, send a pull request to `bdd-lazy-var-next:master`.
...
[github]: https://github.com/kcsujeet/bdd-lazy-var-next
