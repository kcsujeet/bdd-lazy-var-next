// bdd-lazy-var-next requires globals: true in vitest.config.ts to work properly
// With globals: true, you can either:
// - Import from "vitest" (works, mocked by the library)
// - Use global describe/it/expect (also works)
