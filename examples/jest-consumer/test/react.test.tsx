...
describe("Counter Component - Custom Initial Count", () => {
  ...
  subject("customCounter", () => render(<Counter {...get<CounterProps>("customCounterProps")} />));
...
describe("Counter Component - Custom Label", () => {
  ...
  subject("labeledCounter", () => render(<Counter {...get<CounterProps>("labeledCounterProps")} />));
...
describe("UserProfile Component - Admin User", () => {
  ...
  subject("adminProfile", () => render(<UserProfile {...get<UserProfileProps>("adminProfileProps")} />));
...
describe("UserProfile Component - Without Handlers", () => {
  ...
  subject("profileWithoutHandlers", () =>
    render(<UserProfile {...get<UserProfileProps>("profilePropsWithoutHandlers")} />)
  );
